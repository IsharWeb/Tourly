        ...
        <div className="flex justify-between items-center h-15">
          {isDesktop ? (
            ...
            <>
              ...
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-1 cursor-pointer group">
                  ...
                  <button className="text-sm text-gray-500 transition cursor-pointer font-medium group-hover:text-gray-600">
                    Write
                  </button>
                </div>

                <button className="px-4 py-2 rounded-full bg-gray-100 text-sm text-gray-500 font-medium hover:border-gray-500 hover:bg-gray-200 hover:text-gray-700 transition">
                  Subscribe
                </button>
            ...
            <>
              ...
              {/* Right side */}
              <div className="flex items-center gap-3">
                <HiOutlinePencilAlt className="w-5 h-5 text-gray-500 cursor-pointer hover:text-gray-700" />
                <IoNotificationsOutline className="w-5 h-5 text-gray-500 cursor-pointer hover:text-gray-700" />
                <MdOutlineDarkMode className="w-5 h-5 text-gray-500 cursor-pointer hover:text-gray-700" />
              </div>
            </>
          )}
        </div>
