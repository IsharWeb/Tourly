const articles = [
  {
    ...
    link: "/article/italy",
    // small pera or diesction to show below the card imge 
    shortDesc: "From Times Square to Central Park, New York City is",
    content: "The Alps offer breathtaking scenery, charming villages, and excellent skiing opportunities."
  },
  {
    id: 2,
    title: "Discovering Tokyo",
    image: "https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcQsWi5zbz8u9mmAyqXNVlgz6zal7uRFNOlUFCB9a5As0fRVPqU4OwtyfYd8xDAQGWkTOFkrmHnnyffL3Xq0aGLHqh1sABtPvZW2diYMjQ", link: "/article/italy",
    shortDesc: "From Times Square to Central Park, New York City is",
...
const countries = [
  // when user click on link i want add a contry like france is a one cotires but here avilible alot of tour place franct is gatagury and more to placess is sub for example  fance = [tour1 , tour2, tour3, tour4, etc] wheen goto url kike articles/frace to show france related article wich we dicuse on array
  ...
  { name: "USA", image: "https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcQsWi5zbz8u9mmAyqXNVlgz6zal7uRFNOlUFCB9a5As0fRVPqU4OwtyfYd8xDAQGWkTOFkrmHnnyffL3Xq0aGLHqh1sABtPvZW2diYMjQ", link: "/articles/italy" },
